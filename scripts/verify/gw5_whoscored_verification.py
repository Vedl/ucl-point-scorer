"""
GW5 Verification with WhoScored Positions
Tests positional accuracy with updated mapping (Wingers -> FWD).
"""
import pandas as pd
...
print(f"Loaded {len(excel_df)} players from GW5 Excel")

# Matched IDs from probe
# User list vs Found ID
GW5_MATCHES = [
    # 1. Benfica vs Ajax -> Found Ajax vs Benfica (1946446)
    {"name": "Benfica vs Ajax", "sofascore": "https://www.sofascore.com/football/match/benfica-afc-ajax/djbsgkb#id:14566874", 
     "whoscored": "https://www.whoscored.com/Matches/1946446/Live"},
     
    # 2. Union SG vs Galatasaray -> Found Galatasaray vs Union SG (1946488)
    {"name": "Union SG vs Galatasaray", "sofascore": "https://www.sofascore.com/football/match/royale-union-saint-gilloise-galatasaray/llbskXb#id:14566937",
     "whoscored": "https://www.whoscored.com/Matches/1946488/Live"},
     
    # 3. Juventus vs Bodo -> Found Bodo vs Juve (1946427)
    {"name": "Juventus vs Bodo/Glimt", "sofascore": "https://www.sofascore.com/football/match/juventus-bodoglimt/gnsMdb#id:14566842",
     "whoscored": "https://www.whoscored.com/Matches/1946427/Live"},
     
    # 4. Villarreal vs Dortmund -> MISSING WhoScored (Using SofaScore fallback)
    ...
    # 5. Barcelona vs Chelsea -> Found Chelsea vs Barca (1946348)
    {"name": "Barcelona vs Chelsea", "sofascore": "https://www.sofascore.com/football/match/barcelona-chelsea/Nrgb#id:14566580",
     "whoscored": "https://www.whoscored.com/Matches/1946348/Live"},
     
    # 6. Leverkusen vs Man City -> Found Man City vs Leverkusen (1946360)
    {"name": "Leverkusen vs Man City", "sofascore": "https://www.sofascore.com/football/match/bayer-04-leverkusen-manchester-city/rsGdb#id:14566663",
     "whoscored": "https://www.whoscored.com/Matches/1946360/Live"},
     
    # 7. Qarabag vs Napoli -> Found Napoli vs Qarabag (1946469)
    {"name": "Qarabag vs Napoli", "sofascore": "https://www.sofascore.com/football/match/qarabag-napoli/oebsmuc#id:14566902",
     "whoscored": "https://www.whoscored.com/Matches/1946469/Live"},
     
    # 8. Marseille vs Newcastle -> Found 1946462
    {"name": "Marseille vs Newcastle", "sofascore": "https://www.sofascore.com/football/match/olympique-de-marseille-newcastle-united/OsQH#id:14566835",
     "whoscored": "https://www.whoscored.com/Matches/1946462/Live"},
     
    # 9. Slavia Praha vs Athletic -> Found 1946480
    ...
    {"name": "Frankfurt vs Atalanta", "sofascore": "https://www.sofascore.com/football/match/atalanta-eintracht-frankfurt/zdbsLdb#id:14566755",
     "whoscored": "https://www.whoscored.com/Matches/1946431/Live"},
     
    # 15. Liverpool vs PSV -> Found 1946355
    {"name": "Liverpool vs PSV", "sofascore": "https://www.sofascore.com/football/match/psv-eindhoven-liverpool/Uscjb#id:14566638",
     "whoscored": "https://www.whoscored.com/Matches/1946355/Live"},
     
    # 16. Olympiacos vs Real Madrid -> Found 1946383
    {"name": "Olympiacos vs Real Madrid", "sofascore": "https://www.sofascore.com/football/match/olympiacos-fc-real-madrid/EgbsVob#id:14566865",
     "whoscored": "https://www.whoscored.com/Matches/1946383/Live"},
     
    # 17. PSG vs Tottenham -> Found 1946408
    {"name": "PSG vs Tottenham", "sofascore": "https://www.sofascore.com/football/match/paris-saint-germain-tottenham-hotspur/IsUH#id:14566658",
     "whoscored": "https://www.whoscored.com/Matches/1946408/Live"},
     
    # 18. Sporting vs Club Brugge -> Found 1946450
    {"name": "Sporting vs Club Brugge", "sofascore": "https://www.sofascore.com/football/match/sporting-club-brugge-kv/Nhbsbkb#id:14566855",
     "whoscored": "https://www.whoscored.com/Matches/1946450/Live"},
]

all_calculated = []

print("\n" + "=" * 70)
print("RUNNING GW5 VERIFICATION WITH WHOSCORED")
print("=" * 70)
...
for i, match in enumerate(GW5_MATCHES, 1):
    ...
    try:
        ...
        # Use WhoScored URL if available, else fallback to SofaScore (which basically means None since we pass None)
        ws_url = match['whoscored']
        if ws_url:
            print(f"  Using WhoScored: {ws_url}")
        else:
            print(f"  ❌ No WhoScored URL, skipping position override")
            
        df = calc_all_players(match['sofascore'], whoscored_url=ws_url)
...
if all_calculated:
    ...
    print("\n" + "=" * 70)
    print("GW5 VERIFICATION RESULTS (WhoScored Optimized)")
    print("=" * 70)
    ...
    # Save
    comparison.to_csv("gw5_whoscored_results.csv", index=False)
    print(f"\n\n✅ Results saved to: gw5_whoscored_results.csv")
